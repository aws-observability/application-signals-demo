...
module.exports = function(){
  ...
  NutritionFact.insertMany([
    ...
    { pet_type: 'guinea pig', facts: 'Vitamin C-rich pellets, unlimited timothy hay, and fresh vegetables', products: 'GuineaGold Vitamin C Pellets, PiggyPerfect Hay Blend, WheekyWell Veggie Treats' }
  ])
