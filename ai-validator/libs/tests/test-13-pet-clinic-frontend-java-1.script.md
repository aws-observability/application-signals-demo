...
### 5. Search for 'Name = PUT /api/customer/owners/{ownerId}/pets/{petId}'
...
### 10. Search for 'Name = POST /api/visit/owners/{ownerId}/pets/{petId}/visits'
...
### 15. Search for 'Name = POST /api/payments/owners/{ownerId}/pets/{petId}'
...
### 19. Click 'Clear filters'

Click the 'Clear filters' button

### 20. Search for 'Name = POST /api/customer/owners/{ownerId}/pets'

In the search field under 'Service operations' type 'Name = POST /api/customer/owners/{ownerId}/pets' and PRESS Enter.

### 21. Access the graph and open the popup.
...
### 23. Check there is at least one row displayed.
...
### 24. Click 'Clear filters'

Click the 'Clear filters' button

### 25. Search for 'Name = GET /api/visit/owners/{ownerId}/pets/{petId}/visits'
...
### 28. Check there is at least one row displayed.
