...
### 15. Search for 'Name = GET /api/customer/owners/{ownerId}'
...
### 20. Search for 'Name = GET /api/customer/owners/{ownerId}/pets/{petId}'
...
### 25. Search for 'Name = GET /api/customer/diagnose/owners/{ownerId}/pets/{petId}'
