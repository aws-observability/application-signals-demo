...
def get_nutrition_data(pet_type):
    ...
    if not NUTRITION_SERVICE_URL:
        return {"error": True, "facts": "", "products": ""}
...
def create_nutrition_agent():
    ...
    system_prompt = (
        ...
        "- If ANY tool returns 'Please consult veterinarian for recommendations', you MUST respond with EXACTLY that phrase and NOTHING else\n"
        ...
        "- If you cannot access specific nutrition information, always defer to veterinary consultation\n\n"
        "When providing nutrition guidance (ONLY when tools return valid data):\n"
